...
const RoomsAndGuestInput = ({ rooms, setRooms }) => {
      ...
      <div className="pt-10 relative ">
        ...
        >
          ...
          {isDropdownOpen && (
            <div
              ref={dropdownRef}
              className="absolute left-0 right-0 z-20 top-[99%] w-full bg-white border border-green-focus shadow-lg p-4"
            >
...
RoomsAndGuestInput.propTypes = {
  rooms: PropTypes.array.isRequired,
  setRooms: PropTypes.func.isRequired,
};

export default RoomsAndGuestInput;
